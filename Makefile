...
#    Updated: 2019/12/05 17:35:18 by alessandro       ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libft.a
CFLAGS = -Wall -Wextra -Werror -I. -c
SRCS = ft_memset.c ft_memcpy.c ft_memccpy.c ft_memmove.c ft_memchr.c ft_strtrim.c	\
		...
		ft_putendl.c ft_strnew.c ft_putnbr.c ft_isspace.c ft_numlen.c ft_strcat.c	\
		ft_strcmp.c ft_strcpy.c ft_strncat.c ft_strncpy.c ft_strndup.c ft_strstr.c	\
		ft_putstr.c get_next_line.c ft_itoa_base.c ft_itoa.c ft_bzero.c				\
		ft_utoa_base.c 
